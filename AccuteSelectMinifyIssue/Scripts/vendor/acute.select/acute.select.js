...
.controller('acSelectCtrl', ['$scope', '$element', '$window', '$rootScope', '$timeout', '$filter', 'navKey', 'safeApply', 'acuteSelectService', function ($scope, $element, $window, $rootScope, $timeout, $filter, navKey, safeApply, acuteSelectService) {
    ...
    function processSettings() {
        ...
        $scope.longestText = $scope.acPlaceholder;
...
.controller('acScrollToCtrl', ['$scope', '$element', '$attrs', function ($scope, $element, $attrs) {
...
.factory('acuteSelectService', function () {
	...
	var defaultSettings = {
	    "templatePath": "/Scripts/vendor/acute.select",
